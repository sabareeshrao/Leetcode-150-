...
- Day 1 solution: `day-001/Day1Solution.java`
...
Every new day begins with questions/tasks only. Do not include solutions or hints that reveal the solution. A solution is added only after it is explicitly requested.
